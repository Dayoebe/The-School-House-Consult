...
<div>
<p class="mb-5 flex items-center gap-2 text-[11px] font-bold uppercase tracking-[.17em] text-orange"><i class="fa-solid fa-calendar-check text-[13px]" aria-hidden="true"></i> Request a consultation</p><h2 class="mb-6 text-[clamp(30px,3vw,43px)] font-semibold text-navy">Tell us what you have in mind.</h2><p class="text-[15px] text-muted">Share a little about your organisation and the support you are looking for. Your request will be sent to The School House Consult.</p><div class="mt-[38px] border-t border-[#cfd8e4] pt-[30px]"><x-icon name="chat" class="mb-5 text-[#a44a07]" /><h3 class="mb-[15px] text-[21px] font-semibold text-navy">Prefer a direct conversation?</h3><p class="text-[14px] text-muted">Use our phone numbers, email or WhatsApp to get in touch.</p><a class="mt-4 inline-flex items-center gap-3 py-2 text-[13px] font-bold text-navy hover:text-orange" href="{{ config('site.whatsapp') }}"><i class="fa-brands fa-whatsapp text-base text-[#25d366]" aria-hidden="true"></i> WhatsApp Us <i class="fa-solid fa-arrow-up-right-from-square text-[10px]" aria-hidden="true"></i></a>
</div>
</div>
