...
<a class="mt-2 inline-flex items-center gap-3 py-2 text-[13px] font-bold text-navy hover:text-orange" href="{{ config('site.whatsapp') }}"><i class="fa-brands fa-whatsapp text-base text-[#25d366]" aria-hidden="true"></i> WhatsApp Us <i class="fa-solid fa-arrow-up-right-from-square text-[10px]" aria-hidden="true"></i></a>
</div>
